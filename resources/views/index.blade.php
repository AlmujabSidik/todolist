<x-app-layout>
    <section class="container px-4 mx-auto">
        <div class="flex items-center justify-between gap-x-3">
            <h2 class="text-lg font-medium text-gray-800 dark:text-white">Create data an employee</h2>
            <button class="px-6 text-xs py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                Add new employee
            </button>
        </div>
                    ...
                    <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Salary</th>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 class="text-sm font-normal text-emerald-500">Fulltime</h2>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <p class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">$5000</p>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
